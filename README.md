...
Абстрактный, является базовым для моделей данных. Принимает в переменной T тип данных модели. Содержит события Event Emitter для передачи сообщений на слой представления с помощью метода emitChanges.
